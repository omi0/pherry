...
**Done, green, pushed** — 10 workspace projects, 991 tests: `protocol` (110) · `host` (90) · `channel`
(80, audited) · `relay-core` (60) · `sdk` (15) · `transport-node` (11) · `cli` (201) · `control-plane`
(339) · `relay` (31) · `dashboard` (54); plus, outside the workspace, `ios/` — `PherryKit` (50 Swift
tests, conformance-vector-proven against the TS wire) and the app's unit bundle (44). Leg 3c gave the full local, E2EE, multi-viewer custody flow: `pherry board` a
